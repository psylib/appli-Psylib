...
export declare enum SessionPaymentStatus {
    PENDING = "pending",
    PAID = "paid",
    FREE = "free"
}
...
export declare enum CardHoldStatus {
    NONE = "none",
    PENDING = "pending",
    SECURED = "secured",
    CAPTURED = "captured",
...
export declare enum VideoRoomStatus {
    WAITING = "waiting",
    ACTIVE = "active",
    ENDED = "ended"
}
...
export declare enum WaitlistUrgency {
    LOW = "low",
    MEDIUM = "medium",
    HIGH = "high"
}
...
export declare const MON_SOUTIEN_PSY_RATE = 50;
export declare const MON_SOUTIEN_PSY_MAX_SESSIONS = 12;
...
export declare const EXPENSE_CATEGORY_LABELS: Record<ExpenseCategory, string>;
...
export declare const RECURRING_FREQUENCY_LABELS: Record<RecurringFrequency, string>;
...
export declare const DEFAULT_GUARDIAN_PERMISSIONS: GuardianPermissions;
