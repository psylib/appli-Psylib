...
const footerLinks = {
  Produit: [
    ...
    { label: 'PsyLib vs Docorga', href: '/comparaison/psylib-vs-docorga' },
    { label: 'PsyLib vs MaGestionPsy', href: '/comparaison/psylib-vs-magestionpsy' },
    { label: 'PsyLib vs Scriboupsy', href: '/comparaison/psylib-vs-scriboupsy' },
    { label: 'FAQ', href: '/faq' },
        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-charcoal-300 leading-relaxed">
              L&apos;atelier numérique des professionnels de la santé mentale. Conforme HDS, conçu pour la pratique clinique.
            </p>
