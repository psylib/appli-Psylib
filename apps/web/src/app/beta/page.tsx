  ...
  const benefits = [
    {
      icon: Lock,
      title: '43€/mois à vie',
      description: 'Prix gelé pour toujours, même quand les tarifs augmentent à 69€/mois.',
    },
    {
      icon: Star,
            ...
            <div className="text-center mb-12 space-y-4">
              ...
              <div className="flex items-center justify-center gap-4 pt-2">
                <div className="text-center">
                  <div className="text-charcoal-300 line-through text-sm">69€/mois</div>
                  <div className="text-xs text-charcoal-300">tarif Pro standard</div>
                </div>
                <ArrowRight size={16} className="text-charcoal-200" />
                <div className="text-center">
                  <div className="font-dm-mono text-3xl font-bold text-terracotta">43€<span className="text-lg">/mois</span></div>
          ...
          <div className="max-w-2xl mx-auto px-6 space-y-6">
            ...
            {[
              ...
              },
              {
                ...
                a: 'Le tarif de 43€/mois est garanti pour toujours sur votre compte, même quand le tarif Pro standard passera à 69€ ou plus.',
              },
              {
