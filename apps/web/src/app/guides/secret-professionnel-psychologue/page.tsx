      ...
      <article className="mx-auto max-w-3xl px-6 py-16 font-dm-sans text-[#1E1B4B]">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 leading-relaxed">
            ...
            non conforme. PsyLib héberge toutes les données en France chez AZNetwork, hébergeur certifié
            Hébergeur de Données de Santé (HDS V2, 6 activités) et ISO/IEC 27001:2022, et chiffre les notes de séance avec AES-256-GCM.
          </p>
        </section>
        ...
        <section className="mb-10 rounded-2xl bg-[#3D52A0] px-8 py-10 text-center text-white">
          ...
          <p className="mb-6 text-white/80">Chiffrement AES-256, infrastructure certifiée HDS, audit logs. Commencez gratuitement.</p>
