  ...
  '@graph': [
    {
      ...
      url: 'https://psylib.eu',
      featureList:
        'Dossiers patients securises HDS, Notes cliniques structurees (SOAP/DAP), Resume de seance par IA en streaming, Outcome tracking PHQ-9 GAD-7 CORE-OM, Facturation PDF automatique, Comptabilite integree (recettes depenses export FEC preparation 2035), Prise de rendez-vous en ligne, Paiement Stripe a la reservation, Rappels SMS et email automatiques, Liste d attente automatisee, Suivi Mon Soutien Psy 12 seances, Teleconsultation video HD integree HDS, Scribe IA transcription audio de consultation, Alerte place plus tot pour patients (style Doctolib), Partage de documents securise psy vers patient, Compte assistant secretaire avec acces administratif separe du clinique, Espace patient avec mood tracking et journal therapeutique, Exercices therapeutiques personnalises par IA, Notifications temps reel WebSocket, Reseau professionnel entre psychologues, Supervision et intervision, Chiffrement AES-256-GCM',
      offers: {
        '@type': 'AggregateOffer',
        lowPrice: '0',
        highPrice: '79',
