...
export const metadata: Metadata = {
  title: 'Rendez-vous confirme — PsyLib',
        ...
        <div className="max-w-lg w-full">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-[#1E1B4B] leading-snug">
              {isPayment ? (
                <>Votre rendez-vous est<br />confirme et paye.</>
              ) : (
                <>Votre rendez-vous<br />est confirme.</>
              )}
            </h1>
              ...
              {isPayment
                ...
                : (
                  <>
                    ...
                    <strong>24 a 48 heures</strong>. Vous recevrez un email de
